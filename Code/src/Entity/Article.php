...
#[UniqueEntity(fields: ["name"], message: "Un article avec ce nom existe déjà.")]
class Article
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'article', targetEntity: Video::class, orphanRemoval: true, cascade: ['persist'])]
    ...
    public function setMainImageName(?string $image): self
    {
        $this->mainImageName = $image;
